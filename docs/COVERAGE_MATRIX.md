...
> ⚠️ **以下数字为 v0.1.x 时代基线**（vitest 161 + E2E 34 = 195 case）。当前 v0.4.5 实际 **366 单测 + 90 e2e = 456 case**。下面 P0/P1 优先级分析自此未回填，仅作历史路线图 reference。当前测试策略走 schema fuzz / 真实 fixture / 双 MCP 分断面，跟此表结构无直接 1:1 映射。
