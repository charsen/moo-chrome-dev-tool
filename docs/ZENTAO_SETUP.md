...
[下载 v0.2.2 zip](https://gitee.com/charsen/moo-chrome-dev-tool/releases/download/v0.2.2/moo-chrome-dev-tool-0.2.2.zip)（或去 [releases 页](https://gitee.com/charsen/moo-chrome-dev-tool/releases) 拿更新的）→ 解压
