...
> v0.8.1 及更早一句话段见 [docs/handoff-archive/v0.5.x-v0.8.x.md](docs/handoff-archive/v0.5.x-v0.8.x.md)（v0.8.0 / v0.8.1）；v0.7.8 → v0.5.0 仍列于下方（历史堆积，下次清理批量归档）。
...
v0.8.3 已发完。**当前没有强迫性 todo**。本版是单一 feature 增量（截屏标注器加「下载」按钮：合成图直存本地下载目录，免 chrome.downloads 权限），无 BREAKING、行为兼容，用户明示放行跳 dogfood + RELEASE_TEST_CHECKLIST（与 v0.8.2 同款决策）。等用户继续真实 dogfood 反馈，再决定 hotfix 还是新 feature。
